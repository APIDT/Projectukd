  ...
  if (!videoFetching && !video) {
    return (
      <NoResults
        ...
        text="Сторінка, яку ви шукаєте, не існує або була видалена"
      />
    );
  }
  ...
  return (
    ...
    >
      <div className="video-container">
        ...
        <div className="video-info">
          ...
          <div className="video-info-stats">
            <p>
              <span>{video.views} перегляди</span> <span>•</span>{" "}
              <span>{timeSince(video.createdAt)} тому</span>
            </p>
      ...
      <div className="related-videos">
        <h3 style={{ marginBottom: "1rem" }}>наступне</h3>
        {next
